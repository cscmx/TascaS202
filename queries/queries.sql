...
SELECT nombre, precio, (precio * 1)AS precio_usd
FROM producto;
...
SELECT nombre, precio, ROUND((precio * 1.1),2) AS precio_usd
FROM producto;
...
SELECT nombre, truncate(precio,0) as precio_sinDecimales
from producto;
